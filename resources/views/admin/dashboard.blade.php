...
<div class="container-fluid">
  ...
  <div class="alert alert-warning">
      ⚠️ Warning: {{ $lowStockBooks->count() }} books are running low on stock!
      <ul>
          @foreach ($lowStockBooks as $book)
              <li>Book Name: {{ $book->title }} (Stock: {{ $book->stock }})</li>
          @endforeach
      </ul>
  </div>
@endif
      ...
      <tbody>
        @forelse($recentOrders as $order)
          <tr>
            ...
            <td>
              <a href="{{ route('admin.orders.index',$order->id) }}" class="btn btn-sm btn-outline-primary">View</a>
            </td>
          </tr>
        @empty
          <tr>
  ...
  <div class="row g-3 mt-2">
    <div class="col-6 col-md-3">
      <a href="{{ route('admin.products.index') }}" class="btn btn-outline-secondary w-100">Manage Products</a>
    </div>
    <div class="col-6 col-md-3">
      <a href="{{ route('admin.orders.index') }}" class="btn btn-outline-secondary w-100">Manage Orders</a>
    </div>
    <div class="col-6 col-md-3">
      <a href="{{ route('admin.users') }}" class="btn btn-outline-secondary w-100">Manage Users</a>
    </div>
    <div class="col-6 col-md-3">
      <a href="{{ route('admin.reviews.index') }}" class="btn btn-outline-secondary w-100">Manage Reviews</a>
    </div>
  </div>
</div>
@endsection
