...
<div class="form-container <?php echo e($errors->any() ? 'shake' : ''); ?>">
  <h3>Register</h3>
  <form action="<?php echo e(route('register')); ?>" method="POST">
    <?php echo csrf_field(); ?>

    <input type="text" name="name" placeholder="Enter your name" value="<?php echo e(old('name')); ?>" class="box" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <input type="email" name="email" placeholder="Enter your email" value="<?php echo e(old('email')); ?>" class="box" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <p class="text-center mt-2">Already have an account? <a href="<?php echo e(route('login')); ?>">Login here</a></p>
  </form>
</div>
...
<?php /**PATH C:\Users\Rana Dixit\BookStore\BookStore\resources\views/auth/register.blade.php ENDPATH**/ ?>