...
<head>
  ...
  <title>Bookstore - Home</title><link rel="icon" href="<?php echo e(asset('book-icon.png')); ?>?v=2" type="image/png">
  ...
  <style>
    ...
    .header {
      text-align: center;
      padding: 50px;
      background: url('<?php echo e(asset("images/home-bg.jpg")); ?>') no-repeat center center / cover;
...
<span class="navbar-link">
  Welcome,
  <a href="<?php echo e(route('profile')); ?>" class="navbar-link" style="color: #ffd700;">
...
<!-- Shop Icon -->
<a href="<?php echo e(route('shop')); ?>" class="navbar-link">
  <i class="fas fa-store"></i> Shop
</a>

<!-- Cart Icon -->
<a href="<?php echo e(route('cart.view')); ?>" class="navbar-link">
  🛒 Cart <span class="cart-count" style="background: red; color: white; font-size: 12px; font-weight: bold; border-radius: 50%; padding: 3px 7px; position: absolute; top: -8px; right: -12px;"><?php echo e(session('cart') ? count(session('cart')) : 0); ?></span>
</a>

<!-- Order History -->
<a href="<?php echo e(route('order')); ?>" class="navbar-link">
...
<form action="<?php echo e(route('logout')); ?>" method="POST" style="display: inline;">
  ...
  <div class="product-grid">
    ...
    <?php else: ?>
      <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Loop through each book -->
        <div class="product-card">
          <?php if($product->image && file_exists(public_path('images/' . $product->image))): ?>
            <img src="<?php echo e(asset('images/' . $product->image)); ?>" alt="Product Image"> <!-- Book image -->
          <?php else: ?>
            <p>No Image Available</p> <!-- Fallback if no image -->
          <?php endif; ?>
          <h3><?php echo e($product->title); ?></h3> <!-- Book title -->
          <p><?php echo e($product->description); ?></p> <!-- Book description -->
          <p class="price">₹<?php echo e(number_format($product->price, 2)); ?></p> <!-- Book price -->
          <form action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <button type="submit" class="btn">Add to Cart</button> <!-- Add to cart button -->
          </form>
          <!-- View Details Button -->
          <a href="<?php echo e(route('products.details', ['id' => $product->id, 'type' => 'book'])); ?>"
  ...
  <div class="footer">
    ...
    <div>
      <a href="<?php echo e(route('about')); ?>">About Us</a> <!-- About link -->
      <a href="<?php echo e(route('contact')); ?>">Contact Us</a> <!-- Contact link -->
      <a href="<?php echo e(route('privacy')); ?>">Privacy Policy</a> <!-- Privacy Policy link -->
      <a href="<?php echo e(route('terms')); ?>">Terms of Service</a> <!-- Terms of Service link -->
    </div>
  </div>
...
<?php /**PATH C:\Users\Rana Dixit\BookStore\BookStore\resources\views/home.blade.php ENDPATH**/ ?>