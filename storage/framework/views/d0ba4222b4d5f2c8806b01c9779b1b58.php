...
<head>
  ...
  <title>Login | Book Haven</title><link rel="icon" href="<?php echo e(asset('book-icon.png')); ?>?v=2" type="image/png">
...
<?php endif; ?>
    ...
    <div class="form-container <?php echo e(($errors->any()) ? 'shake' : ''); ?>">
      ...
      <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter your email" class="box" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center mt-2">Don't have an account? <a href="<?php echo e(route('register')); ?>">Register here</a></p>
      </form>
    </div>
  </div>
...
<?php /**PATH C:\Users\Rana Dixit\BookStore\BookStore\resources\views/auth/login.blade.php ENDPATH**/ ?>