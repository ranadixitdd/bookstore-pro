...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('book-icon.png')); ?>?v=2" type="image/png">
    <title>My Bookstore - <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <style>
        ...
        /* ========================================================== */
        body {
    background: url('<?php echo e(asset("images/allinone.jpg")); ?>') no-repeat center center fixed;
...
<body>
    ...
    <div class="navbar">
        ...
        <div>
            ...
            <a href="<?php echo e(route('products.list')); ?>"><i class="fas fa-store"></i> Shop</a>

            <!-- ========================================================== -->
            <!-- 🌟 CART LINK WITH DYNAMIC COUNT -->
            <!-- ========================================================== -->
            <a href="<?php echo e(route('cart.view')); ?>" class="cart-link">
                🛒 Cart <span class="cart-count"><?php echo e(session('cart') ? count(session('cart')) : 0); ?></span>
            </a>
            ...
            <!-- ========================================================== -->
            <?php if(auth()->check()): ?>
                <a href="<?php echo e(route('profile')); ?>"><i class="fas fa-user"></i> Profile</a>
    ...
    <!-- ========================================================== -->
    <div class="content">
        <?php echo $__env->yieldContent('content'); ?> <!-- Page-specific content will be inserted here -->
    </div>
...
<?php /**PATH C:\Users\Rana Dixit\BookStore\BookStore\resources\views/layouts/app.blade.php ENDPATH**/ ?>