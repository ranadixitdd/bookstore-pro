    ...
    <div class="glass-card">
        ...
        <?php if(session('reset_link')): ?>
            <div class="message" style="background: #222; color: #00e7ff;">
                ...
                <a href="<?php echo e(session('reset_link')); ?>" style="color: #00ffe7; word-break: break-all;">
...
$message = $__bag->first($__errorArgs[0]); ?>
                <div class="error-message"><i class="fas fa-exclamation-triangle"></i> <?php echo e($message); ?></div>
            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <a href="<?php echo e(route('login')); ?>"><i class="fas fa-arrow-left"></i> Back to Login</a>
    </div>

</body>
</html>
<?php /**PATH C:\Users\Rana Dixit\BookStore\BookStore\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>